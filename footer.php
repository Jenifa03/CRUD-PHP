    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-lg-4 mb-4 mb-lg-0">
                <a href="#" class="fables-second-border-color border-bottom pb-3 d-block mb-3 mt-minus-13"><img src="assets/custom/images/Kramah_Logo.jpg" alt="fables template"></a>
